...
module.exports = class Strategy_V2 {
    static apply() {
        ...
        if (gb.lastSellers > gb.lastBuyers && gb.lastAction !== conf.BUY && gb.lastSellPrice >= gb.currentMarketPrice && gb.lastOrderWasFilled) {
        ...
        if (gb.lastBuyers > gb.lastSellers && gb.lastAction !== conf.SELL && gb.lastBuyPrice < gb.currentMarketPrice && gb.lastOrderWasFilled) {
