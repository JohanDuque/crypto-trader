...
module.exports = class Strategy_V2 {
    static apply() {
        ...
        if (gb.currentBuyers > gb.currentSellers && gb.lastAction !== conf.BUY && gb.lastSellPrice >= gb.currentMarketPrice && gb.lastOrderWasFilled) {
        ...
        if (gb.currentSellers > gb.currentBuyers && gb.lastAction !== conf.SELL && gb.lastBuyPrice < gb.currentMarketPrice && gb.lastOrderWasFilled) {
