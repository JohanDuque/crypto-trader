...
module.exports = class Strategy_V3 {
    static apply() {
        ...
        if (gb.lastAction !== gb.buyAction && gb.lastSellPrice >= gb.currentMarketPrice && gb.lastOrderWasFilled) {
        ...
        if (gb.lastAction !== gb.sellAction && gb.lastBuyPrice < gb.currentMarketPrice && gb.lastOrderWasFilled) {
        ...
        if (gb.buyOrders === 0 && gb.asksAverage > gb.bidsAverage) {
